...
const SUPABASE_URL      = 'https://atbftoukhambwrscgqvj.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF0YmZ0b3VraGFtYndyc2NncXZqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk5NTA2ODMsImV4cCI6MjA5NTUyNjY4M30.51VXDOMlws6QCDuEGo68bGxbHjnni_mqhY7Z6Cpu2ic';
...
async function loadReviews() {
  ...
  try {
    const res  = await supabaseGet('reviews', 'select=*&order=created_at.desc&limit=100');
...
async function submitReview(e) {
  ...
  try {
    const res = await supabasePost('reviews', {
      customer_name: name,
      product,
      rating,
      review_text: text,
